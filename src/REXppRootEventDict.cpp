...
#define R__DICTIONARY_FILENAME srcdIREXppRootEventDict
...
"./LISETools/",
"./include/",
"/software/root-6.16.00/build/include",
"/home/daniele/Dropbox/Ricerca/Ruder_Boskovic/2019_Mg24/REX++/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("REXppRootEventDict",
        ...
        TriggerDictionaryInitialization_REXppRootEventDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
